...
extern "C"
JNIEXPORT jint JNICALL
Java_com_lordsunext_manager_Natives_getKernelUAPIVersion(JNIEnv *env, jobject) {
    return get_kernel_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_lordsunext_manager_Natives_getManagerUAPIVersion(JNIEnv *env, jobject) {
