...
Java_com_lordsu_manager_Natives_getVersion(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_lordsu_manager_Natives_getManagerAppid(JNIEnv *env, jobject) {
...
Java_com_lordsu_manager_Natives_getHookMode(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_lordsu_manager_Natives_getVersionTag(JNIEnv *env, jobject) {
...
// Java_com_lordsu_manager_Natives_getAllowList(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_lordsu_manager_Natives_getKernelUAPIVersion(JNIEnv *env, jobject) {
    return get_kernel_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_lordsu_manager_Natives_getManagerUAPIVersion(JNIEnv *env, jobject) {
    return get_manager_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_lordsu_manager_Natives_getSuperuserCount(JNIEnv *env, jobject) {
...
Java_com_lordsu_manager_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isLateLoadMode(JNIEnv *env, jclass clazz) {
    return is_late_load_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isManager(JNIEnv *env, jclass clazz) {
    return is_manager();
}
...
Java_com_lordsu_manager_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("com/lordsu/manager/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("com/lordsu/manager/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
    return uid_should_umount(uid);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isSuEnabled(JNIEnv *env, jobject thiz) {
    return is_su_enabled();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_setSuEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_su_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isZygiskEnabled(JNIEnv *env, jobject) {
    return is_zygisk_enabled();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isKernelUmountEnabled(JNIEnv *env, jobject thiz) {
    return is_kernel_umount_enabled();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_setKernelUmountEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_kernel_umount_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isAdbRootEnabled(JNIEnv *env, jobject thiz) {
    return is_adb_root_enabled();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_setAdbRootEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_adb_root_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isSelinuxHideEnabled(JNIEnv *env, jobject thiz) {
    return is_selinux_hide_enabled();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_lordsu_manager_Natives_setSelinuxHideEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_selinux_hide_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_isAvcSpoofEnabled(JNIEnv *env, jobject thiz) {
    return is_avc_spoof_enabled();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_lordsu_manager_Natives_setAvcSpoofEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_avc_spoof_enabled(enabled);
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_lordsu_manager_Natives_getUserName(JNIEnv *env, jobject thiz, jint uid) {
